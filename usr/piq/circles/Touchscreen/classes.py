...
##### MEDIA #####
fire = pyglet.media.load('/home/pi/oc-2018/games2/circles/Touchscreen/resources/sound/fire.wav', streaming=False)
...
class Player(pyglet.sprite.Sprite):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.image = pyglet.resource.image('/home/pi/oc-2018/games2/circles/Touchscreen/resources/sprites/player.png')
...
class Feather(pyglet.sprite.Sprite):
    ...
    feather = pyglet.resource.image('/home/pi/oc-2018/games2/circles/Touchscreen/resources/sprites/feather.png')
...
class Poetry():
    ...
    poetry = open("/home/pi/oc-2018/games2/circles/Touchscreen/resources/documents/poeme.txt", encoding='utf8')
    ...
    def save_words(self):
        ...
        :return: None
        '''
        with open('/home/pi/oc-2018/games2/circles/Touchscreen/resources/documents/words.txt', 'w', encoding='utf8') as filehandle: #save the words in a txt document
    ...
    def open_words(self):
        ...
        :return: list
        '''
        return open("/home/pi/oc-2018/games2/circles/Touchscreen/resources/documents/words.txt", encoding='utf8').read().split('\n') #open the file containing the words
...
class RotatingSprite(pyglet.sprite.Sprite):
    ...
    circle_segment = pyglet.image.load("/home/pi/oc-2018/games2/circles/Touchscreen/resources/sprites/circle_segment.png")
    center_image(circle_segment)
    dead_segment = pyglet.image.load('/home/pi/oc-2018/games2/circles/Touchscreen/resources/sprites/circle_segment_grey.png')
