...
class Feather(pyglet.sprite.Sprite):
    ...
    speed = 500 * game_window.width/1920 # Norm of the velocity
...
##### POETRY #####
def random_poetry():
    '''Choose randomly a poeam in the folder /resources/documents/'''
    poem_list = glob.glob('resources/documents/*.txt')
